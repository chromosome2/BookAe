...
<body>
    ...
    <div id="wrapper">
        ...
        <section class="memberJoin">
            <h2>회원가입</h2>
            <form action="${contextPath }/join/addMember.do" method="post" id="joinForm" name="joinForm">
                <fieldset>
                    ...
                    <p>
                        ...
                        <input type="button" id="btn_duplicate" value="중복체크" onclick="fn_idCheck()"> 
                        <span class="logInfo"></span>
                    </p>
                    <p>
                        <input type="password" id="password" name="password" required placeholder="비밀번호">
                        <span class="logInfo">*8~16자 영문 대 소문자, 숫자를 사용하세요.</span>
                    </p>
                    <p>
